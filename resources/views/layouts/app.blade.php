        ...
        <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                ...
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item me-auto">
                        <a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html">
                            ...
                            <h2 class="brand-text">XIWAY NOTE</h2>
                        </a>
                    </li>
            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item {!!(Request::is('jokis*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('jokis.index') }}">
                            <i data-feather="check-square"></i>
                            <span class="menu-title text-truncate">Jokian</span>
                        </a>
                    </li>
                    <li class="nav-item {!!(Request::is('bank-accounts*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('bank-accounts.index') }}">
